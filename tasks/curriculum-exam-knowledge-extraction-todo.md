...
- 状态：实施中；CEK-33 与 Checkpoint G2 已完成 repo-side 本机浏览器闭环，下一实现项为 CEK-34；真实教师签字、身份授权、学校网络、隔离机、生产激活和 `REAL005` 仍开放
...
- [x] CEK-27 隔离库 reviewed -> active -> rollback 演练与生产决策包
  ...
  - 决策：生产 `NO-GO`；`drill_reviewer` 不等于真实教师审核，身份授权、CEK-20 持久化、CEK-33/34、`REAL005` 和生产切换明确授权仍开放。
