...
| P3 | P1/P2 黄金样本和 schema 稳定，且 C002 已由教师录入/导入教材、课程标准、近年当地真题等来源资料后完成提炼与审核 | AI 输出结构化、可评测、可追踪成本、可人工接管 |
...
目标：建立稳定的初中物理 L1-L3 知识体系，并把教材、课标、地区考点作为映射层。
...
P3 不得用 draft bootstrap 知识点作为正式输入。若 C002 仍为 `暂缓`，D001-D003 只能停留在 schema/接口规划，不得接真实模型、不得标记完成。
