...
| I0 教师工作流产品化 | 四个教师入口形成顺滑页面闭环 | 导入、组卷、成绩导入、分析均能代理完成，普通教师不接触脚本、证据术语或知识治理工作台 |
...
近期只应执行 H/I/J/K 的收口与复核项。L 以后必须等前置证据通过，不要因为任务已写入长期路线图就提前扩大功能面。
...
| I0 教师工作流产品化 | I001-I008 已完成 | 普通教师四入口收口，高级治理工作台默认隐藏 |
| J0 真实文档解析 | J001-J006 已完成 | 已有 adapter 合同和准确率代理基线，后续只补真实样本反馈 |
| K0 知识资产生产使用 | K001-K006 已完成 | 能服务 active C002 查询和管理员治理，但不得回流到普通教师默认页 |
| L0 以后 | 待办 | 真实 AI、真实学生数据、安装发布和多学科扩展继续后置 |

近期执行项已从 H/I/J 扩展到 H/I/J/K 的完成态复核：H0 负责收口和漂移守卫，I0 负责教师默认入口和工作台产品化，J0 负责真实 docx/PDF/OCR adapter 与导入准确率基线，K0 只作为管理员/系统治理能力存在。进入 L0 前，必须先维持 I008 教师简洁合同、补齐真实 AI 准入和角色守卫。
