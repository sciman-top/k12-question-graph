...
复核来源类型：Microsoft Learn、OpenAI 官方文档、PostgreSQL/React/Vite/Ant Design/TanStack/React Router 官方文档、1EdTech/OWASP/NIST/WCAG 标准说明、Moodle/Open edX/Paperless-ngx 等社区项目。
