...
- real005_report_path: docs/evidence/20260725-real005-guangzhou-2015-2025-closure-standard-report.json
...
## Rollback
git restore tasks/non-site-implementation-plan.csv tools/run-gates.ps1 tools/README.md; git clean -f -- tools/run-ns905-status-sync-audit.ps1 docs/evidence/20260725-ns905-status-sync.md
