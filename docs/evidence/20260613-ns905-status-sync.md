...
- real005_next_slice_status: blocked
- real005_next_slice_blockers: RG001 source manifest coverage is still blocked for years: 2020 | RG002 adapter diagnostics are incomplete for years: 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025
...
## Rollback
git restore tasks/non-site-implementation-plan.csv tools/run-gates.ps1 tools/README.md; git clean -f -- tools/run-ns905-status-sync-audit.ps1 docs/evidence/20260613-ns905-status-sync.md
