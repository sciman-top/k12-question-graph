...
- status: pass
- checked_at: 2026-06-20T21:37:09
...
## Evidence Inputs
- liveCloseoutGuard: `docs/evidence/20260620-live-pilot-closeout-plan-guard.json`
- real005Report: `docs/evidence/20260620-real005-guangzhou-2015-2025-closure-standard-report.json`
- statusSyncReport: `docs/evidence/20260620-ns905-status-sync.md`
...
## Rollback
git clean -f -- tools/run-live-pilot-closeout-repo-side-audit.ps1 docs/evidence/20260620-live-pilot-closeout-repo-side-audit.json docs/evidence/20260620-live-pilot-closeout-repo-side-audit.md; git restore tools/README.md
