...
## Evidence Inputs
- liveCloseoutGuard: `docs/evidence/20260618-live-pilot-closeout-plan-guard.json`
- real005Report: `docs/evidence/20260618-real005-guangzhou-2015-2025-closure-standard-report.json`
- statusSyncReport: `docs/evidence/20260618-ns905-status-sync.md`
...
- p001: `docs/evidence/20260617-p001-live-pilot-readiness-preflight-report.json`
...
## Rollback
git clean -f -- tools/run-live-pilot-closeout-repo-side-audit.ps1 docs/evidence/20260618-live-pilot-closeout-repo-side-audit.json docs/evidence/20260618-live-pilot-closeout-repo-side-audit.md; git restore tools/README.md
