...
- status: pass
- checked_at: 2026-05-31T00:21:45
- task_id: NS905
...
- status.planned: 7
- status.repo_landed: 12
- status.runtime_verified: 49
...
- next_planned_task_after_this_sync: NS1104
...
## Rollback
git restore tasks/non-site-implementation-plan.csv tools/run-gates.ps1 tools/README.md; git clean -f -- tools/run-ns905-status-sync-audit.ps1 docs/evidence/20260530-ns905-status-sync.md
