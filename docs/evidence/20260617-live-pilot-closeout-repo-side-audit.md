...
- status: pass
- checked_at: 2026-06-17T22:34:46
...
- full_gate_note: REAL005D truth-boundary refresh only; no full gate rerun in this slice
...
## Evidence Inputs
- liveCloseoutGuard: `docs/evidence/20260617-live-pilot-closeout-plan-guard.json`
- real005Report: `docs/evidence/20260617-real005-guangzhou-2015-2025-closure-standard-report.json`
- statusSyncReport: `docs/evidence/20260617-ns905-status-sync.md`
...
## Rollback
git clean -f -- tools/run-live-pilot-closeout-repo-side-audit.ps1 docs/evidence/20260617-live-pilot-closeout-repo-side-audit.json docs/evidence/20260617-live-pilot-closeout-repo-side-audit.md; git restore tools/README.md
