...
- status: pass
- checked_at: 2026-07-30T23:02:39
- task_id: NS905
...
- parent.P006: 5
- parent.REAL005: 4
- next_open.REAL005: none
- next_open.P001: P001A
- next_open.P003: P003A
- next_open.P005: P005A
- next_open.P006: P006A
- real005_report_path: docs/evidence/20260730-real005-guangzhou-2015-2025-closure-standard-report.json
...
## Rollback
git restore tasks/non-site-implementation-plan.csv tools/run-gates.ps1 tools/README.md; git clean -f -- tools/run-ns905-status-sync-audit.ps1 docs/evidence/20260730-ns905-status-sync.md
