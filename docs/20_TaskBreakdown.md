...
- C002 初中物理 L1-L3 知识点初始化。暂缓：正式知识点必须在教师录入各版本教材、学科课程标准、近年当地中考/高考真题等资料后，从来源提炼并审核；当前非权威 draft bootstrap 可用于测试绑定、筛选和映射历史验证，但不能作为正式完成证据。来源资料准入见 `docs/50_C002_SourceMaterialAdmission.md`。
- C003 公式、实验、方法、易错点。
- C004 教材章节映射。
- C005 地区考点映射。
- C006 AI 映射建议。
...
若 C002 仍为暂缓，P3 入口继续阻断；D001 依赖正式来源提炼后的 C002，不得使用非权威 draft bootstrap 知识点作为 AI 标注或模型路由完成证据。
