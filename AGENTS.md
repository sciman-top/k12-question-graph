...
**承接来源**: `GlobalUser/AGENTS.md v9.48`
...
- 目前不是 Git 仓库；进入实质编码前必须初始化 Git 或明确替代版本化/回滚策略。
...
rg -n "A000|A000A|P0|P1" README.md docs/19_Roadmap.md docs/20_TaskBreakdown.md tasks/backlog.csv
```
...
- 当前仓未初始化 Git；做代码级或多文件结构性变更前，先建立 Git 基线或明确等价回滚方案。
