...
- 当前已有 API、Web、Worker、PostgreSQL/EF Core migrations、FileStore、backup、统一 gate、P1 导入闭环、P2 动态资产合同、C002 初中物理 v1 active、C002R active 后修订合同、P3 draft/test AI 合同和 P4 draft/test 题库检索合同。
