...
try {
    ...
    $report = [ordered]@{
        ...
        rollback = 'git restore tasks/non-site-implementation-plan.csv; git clean -f -- tools/run-ns403-review-workbench-ui.ps1 docs/evidence/20260530-ns403-review-workbench-ui-report.json'
    }
