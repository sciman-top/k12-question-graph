...
try {
    ...
    $s007cApiPort = Get-FreeTcpPort
    $s006bApiPort = Get-FreeTcpPort
    $s009bApiPort = Get-FreeTcpPort
    $s010bApiPort = Get-FreeTcpPort
    $s011aApiPort = Get-FreeTcpPort
    $s011bApiPort = Get-FreeTcpPort
    $s011cApiPort = Get-FreeTcpPort
