...
$report = [ordered]@{
    ...
    fullGate=[ordered]@{status='gate_na';reason='tools/run-gates.ps1 is reserved for CEK-34 due to PostgreSQL/API process impact';alternative_verification='Release build, schema fixtures, roadmap/reference guards, and static checks';evidence_link='docs/evidence/cek011-assessment-target-contract.json';expires_at='CEK-34';recovery_condition='obtain planned confirmation and run tools/run-gates.ps1 at CEK-34'}
