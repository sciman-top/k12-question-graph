...
try {
    ...
    $report = [ordered]@{
        ...
        rollback = "Remove-Item -LiteralPath 'tmp/ns806' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -LiteralPath 'tmp/o007' -Recurse -Force -ErrorAction SilentlyContinue; git restore tools/README.md; git clean -f -- tools/run-ns806-upgrade-bundle.ps1 $ReportPath"
